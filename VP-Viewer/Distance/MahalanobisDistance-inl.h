...
template <class ObjectType>
double MahalanobisDistance<ObjectType>::getDistance(const ObjectType &obj1)throw (std::length_error){
...
*/
template <class ObjectType>
double  MahalanobisDistance<ObjectType>::GetDistance(const ObjectType &obj1, const ObjectType &obj2) throw (std::length_error){
...
*/
template <class ObjectType>
double  MahalanobisDistance<ObjectType>::getDistance(const ObjectType &obj1, std::vector<ObjectType> obj2) throw (std::length_error){
