...
*/
template<class T>
bool InvertMatrix (boost::numeric::ublas::matrix<T>& input, boost::numeric::ublas::matrix<T>& inverse) {
...
class MahalanobisDistance : public DistanceFunction <ObjectType>{
    ...
    public:
        ...
        double GetDistance(const ObjectType &obj1, const ObjectType &obj2) throw (std::length_error);
        double getDistance(const ObjectType &obj1, const ObjectType &obj2) throw (std::length_error);
        double getDistance(const ObjectType &obj1, std::vector<ObjectType> obj2) throw (std::length_error);
        double getDistance(const ObjectType &obj1)throw (std::length_error);
};
