...
class BasicArrayObject{
    ...
    public:
        ...
        */
        BasicArrayObject(u_int32_t OID, std::vector<DType> &data){
        ...
        */
        void unserialize(u_char *dataIn, size_t dataSize = 0){
        ...
        * Use unserialize(u_char *dataIn, u_int32_t dataSize) instead.
        * @copydoc unserialize(u_char *dataIn, size_t dataSize).
        */
        void Unserialize(u_char *dataIn, size_t dataSize = 0){
