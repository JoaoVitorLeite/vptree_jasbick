...
////    run_experiments_on("Poker_Hand", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/1025010 | 10 PokerHand.csv", 502, 10, 50,
...
////    run_experiments_on("HIGGS", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/11000000 | 29 HIGGS.csv", 501, 29, 50,
////                      new ManhattanDistance<InstanceDouble>(), "Manhattan");
...
////    run_experiments_on("Superconductivity", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/21263 | 81 Superconductivty.csv", 21263, 81, 500,
////                      new CanberraDistance<InstanceDouble>(), "Canberra");

////    run_experiments_on("Buzz_in_social_media_TomsHardware", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/28179 | 97 Buzz in Social media Dataset TomsHardware.csv", 28179, 97, 500,
////                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");
...
//    /**Falta SelectVP**/run_experiments_on("Sensorless_drive", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/58509 | 59 Sensorless_drive_diagnosis.csv", 58509, 59, 500,
//                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");

//    /**Falta SelectVP**/run_experiments_on("Sgemm_product", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/241600 | 4 sgemm_product.csv", 241600, 4, 500,
//                      new CanberraDistance<InstanceDouble>(), "Canberra");
...
////    **Falta TUDO**run_experiments_on("YearPredictionMSD", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/515345 | 90 YearPredictionMSD.csv", 515345, 90, 500,
////                      new CanberraDistance<InstanceDouble>(), "Canberra");
...
////    run_experiments_on("Poker_Hand", "/home/notox/VP-Viewer Experimentos Nuvem/Datasets/1025010 | 10 PokerHand.csv", 1025010, 10, 500,
////                      new EuclideanDistance<InstanceDouble>(), "Euclidean");
