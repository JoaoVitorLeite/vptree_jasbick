...
//    DONE run_experiments_on("Superconductivity", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/21263 | 81 Superconductivity.csv", 21263, 81, 500,
//                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");

//    run_experiments_on("Buzz_in_social_media_TomsHardware", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/28179 | 97 Buzz in Social media Dataset TomsHardware.csv", 28179, 97, 500,
//                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");

//    DONE run_experiments_on("OnlineNewsPopularity", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/39644 | 58 OnlineNewsPopularity.csv", 39644, 58, 500,
//                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");

//    DONE run_experiments_on("Physicochemical_Properties", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/45730 | 9 Physicochemical_Properties.csv", 45730, 9, 500,
//                      new BrayCurtisDistance<InstanceDouble>(), "BrayCurtis");

    run_experiments_on("RelationNetwork", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/53413 | 23 Relation Network.csv", 53413, 23, 500,
                      new CanberraDistance<InstanceDouble>(), "Canberra");

    run_experiments_on("Sensorless_drive", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/58509 | 48 Sensorless_drive_diagnosis.csv", 58509, 48, 500,
                      new CanberraDistance<InstanceDouble>(), "Canberra");

//    run_experiments_on("Sgemm_product", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/241600 | 4 sgemm_product.csv", 241600, 4, 500,
//                      new CanberraDistance<InstanceDouble>(), "Canberra");

//    run_experiments_on("Skin_NonSkin", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/245057 | 4 Skin_NonSkin.csv", 245057, 4, 500,
//                      new CanberraDistance<InstanceDouble>(), "Canberra");

    run_experiments_on("3D_spatial_network", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/434874 | 3 3D_spatial_network.csv", 434874, 3, 500,
                      new ChebyshevDistance<InstanceDouble>(), "Chebyshev");

//    run_experiments_on("YearPredictionMSD", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/515345 | 90 YearPredictionMSD.csv", 515345, 90, 500,
//                      new ChebyshevDistance<InstanceDouble>(), "Chebyshev");

//    run_experiments_on("COVERTYPE", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/581012 | 54 COVERTYPE.csv", 581012, 54, 500,
//                      new ChebyshevDistance<InstanceDouble>(), "Chebyshev");

//    run_experiments_on("Buzz_in_social_media_Twitter", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/583250 | 78 Buzz in Social media Dataset Twitter.csv", 583250, 78, 500,
//                      new ChebyshevDistance<InstanceDouble>(), "Chebyshev");

//    run_experiments_on("FONTS", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/832822 | 410 FONTS.csv", 832822, 410, 500,
//                      new EuclideanDistance<InstanceDouble>(), "Euclidean");

//    run_experiments_on("Gas_sensors_home", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/928991 | 12 Gas sensors for home activity monitoring Data Set.csv", 928991, 12, 500,
//                      new EuclideanDistance<InstanceDouble>(), "Euclidean");

//    run_experiments_on("Poker_Hand", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/1025010 | 10 PokerHand.csv", 1025010, 10, 500,
//                      new EuclideanDistance<InstanceDouble>(), "Euclidean");

//    run_experiments_on("Gas_sensors_dynamic_methane", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/4178504 | 19 Gas sensor array under dynamic gas mixtures Data Set ethylene_methane.csv", 4178504, 19, 500,
//                      new EuclideanDistance<InstanceDouble>(), "Euclidean");

//    run_experiments_on("Gas_sensors_dynamic_CO2", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/4208261 | 19 Gas sensor array under dynamic gas mixtures Data Set ethylene_CO.csv", 4208261, 19, 500,
//                      new ManhattanDistance<InstanceDouble>(), "Manhattan");

//    run_experiments_on("SUSY", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/5000000 | 19 SUSY.csv", 5000000, 19, 500,
//                      new ManhattanDistance<InstanceDouble>(), "Manhattan");

//    run_experiments_on("HEPMASS", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/10500000 | 28 hepmass.csv", 10500000, 28, 500,
//                      new ManhattanDistance<InstanceDouble>(), "Manhattan");

//    run_experiments_on("HIGGS", "/home/notox/VP-Viewer Nuvem Otimizacao/Datasets/OK/11000000 | 29 HIGGS.csv", 11000000, 29, 500,
//                      new ManhattanDistance<InstanceDouble>(), "Manhattan");
