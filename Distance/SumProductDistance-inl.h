...
template <class ObjectType>
double SumProductDistance<ObjectType>::getPartialDistance(const ObjectType &o1, const ObjectType &o2, uint32_t i) {
...
*/
template <class ObjectType>
double SumProductDistance<ObjectType>::GetDistance(const ObjectType &o1, const ObjectType &o2) {
