...
int main(int argc, char *argv[]){
    ...
    train->doubleFileToDataset(train, "/home/joaovictor/Code/vptree_jasbick/Datasets/train_ulcer_SPP.csv", 40402, 12);
    DatasetDouble *train2 = new DatasetDouble();
    train2->doubleFileToDataset(train2, "/home/joaovictor/Code/vptree_jasbick/Datasets/train_ulcer_SPP.csv", 40402, 12);
    DatasetDouble *test = new DatasetDouble();
    test->doubleFileToDataset(test, "/home/joaovictor/Code/vptree_jasbick/Datasets/test_ulcer_SPP.csv", 4490, 12);
